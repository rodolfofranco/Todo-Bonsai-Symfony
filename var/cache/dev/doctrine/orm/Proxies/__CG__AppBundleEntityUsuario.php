...
class Usuario extends \AppBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'wishlist', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'carrito', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'correo', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'clave', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'pais', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'direccion', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'orden', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'plainPassword'];
        }
    ...
    public function setPlainPassword($clave)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPlainPassword', [$clave]);

        return parent::setPlainPassword($clave);
    }
     ...
     * {@inheritDoc}
     */
    public function removeOrden(\AppBundle\Entity\Orden $orden)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeOrden', [$orden]);
